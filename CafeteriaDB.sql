...
show tables;
select * from pedidos;
alter table clientes change `first_name` `primeiro_nome` VARCHAR(25);
alter table clientes change `last_name` `ultimo_nome` VARCHAR(25);
DEscribe pedidos;

alter table clientes modify primeiro_nome varchar(30);
alter table clientes modify ultimo_nome varchar(30);

alter table clientes add email varchar(25);

alter table clientes add constraint u_mail unique (email);
use cafeteria;
select * from pedidos;
insert into pedidos (produto_id, cliente_id, data_pedido)
values (5,22,'2017-02-05 09-07-10'),(3,23,'2017-02-06 08-15-10'),(2,24,'2017-02-07 08-27-26'),(1,1,'2017-02-07 08-45-10'),(6,11,'2017-02-08 10-37-10'),(3,13,'2017-02-09 08-58-18'),(3,14,'2017-02-10 09-12-40'),(5,4,'2017-02-10 11-05-34'),(1,2,'2017-02-11 08-00-38'),(3,8,'2017-02-12 08-08-08');
